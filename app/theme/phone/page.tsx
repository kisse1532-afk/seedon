    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-3">
        ...
        {items.map((p) => (
          <div
            key={p.id}
            className="rounded-2xl border border-sage-border bg-white p-5 flex flex-col gap-2"
          >
            <div className="flex items-start justify-between gap-2">
              ...
              {p.last_verified_at && (
                <span className="text-[10px] text-meta whitespace-nowrap shrink-0">
            ...
            <div className="flex items-center justify-between mt-2 flex-wrap gap-2">
              <a
                ...
                className="text-xs font-medium text-primary-deep bg-mint rounded-full px-3 py-1 hover:bg-mint/70"
              >
                📞 {p.phone}
              </a>
              <TrackedLink
