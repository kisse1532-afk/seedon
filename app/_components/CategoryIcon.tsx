...
const PATHS: Record<Category, React.ReactNode> = {
  ...
  contest: (
    <>
      <path d="M8.1 4.6h7.8v4.6a3.9 3.9 0 0 1-7.8 0Z" />
      <path d="M8.1 6.1H5.5v1.3a3 3 0 0 0 2.6 3M15.9 6.1h2.6v1.3a3 3 0 0 1-2.6 3" />
      <path d="M12 13.1v3.1M9 19.4h6M9.6 19.4c0-1.8.7-3.2 2.4-3.2s2.4 1.4 2.4 3.2" />
    </>
  ),
  // 문화체험 — 티켓
  culture: (
