 ...
 *
 * 50%(324) / 100%(649) / 150%(974) — 제도마다 쓰는 기준선이 달라서 셋 다 나온다.
 * 새 기준선을 쓰는 카드를 만들면 여기에도 같이 추가할 것. 안 그러면 규칙을
 * 지킨 카드가 "근거 없는 금액"으로 잡혀서 도구를 아무도 안 믿게 된다.
 */
const OUR_OWN_MATH = new Set(["324만원", "649만원", "974만원"]);
